					...
					<nav id="menu">
						<div class="inner">
							...
							<ul class="links">
								...
								<li><a href="pass-login.php">User Login</a></li>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">+91-9845827805</li>
								<li class="icon solid fa-envelope"><a href="#">naven@gmail.com</a></li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: Naveen D</li>
							</ul>
						</div>
					</section>
